...
function showDedicationText() { //seguidores
  ...
  if (!text) {
    text = `Para la tomatina mas tomatina del mundo:\n\nMuchas gracias por todas aquellas cosas tan lindas que haces por mi, de verdad que estoy demasiado agradecido contigo mi niña\n\nEres la mujer más preciosa y maravilosa del mundo, te amo con todo mi corazoncito mi princesita bella.`;  } else {
...
function showSignature() {
  ...
  signature.textContent = firma ? decodeURIComponent(firma) : "Con muchisimo amor, Mandi.";
...
function showCountdown() {
  ...
  let eventDate = eventParam ? new Date(eventParam + 'T00:00:00') : new Date('2026-09-05T00:00:00');
